...
public class OriginalNasaApplet extends java.applet.Applet {
...
//
    ...
    public void loadInput() {   // load the input panels
        ...
        if (lunits == 0) {
            ...
            if (planet == 2) {
                in.flt.inl.l2.setText("Depth-ft");
            }
            if (planet != 2) {
                in.flt.inl.l2.setText("Altitude-ft");
            }
        }
        if (lunits == 1) {
            ...
            if (planet == 2) {
                in.flt.inl.l2.setText("Depth-m");
            }
            if (planet != 2) {
                in.flt.inl.l2.setText("Altitude-m");
            }
        }
        v1 = chord;
        chrdmn = 0.1 * lconv;
        ...
        v3 = area;
        armn = armin * lconv * lconv;
        armx = armax * lconv * lconv;
        v4 = vfsd;
        vmn = 0.0;
        vmx = vmax;
        v5 = alt;
...
//        if (foil == 5) lift = lift * 3.1415926 / 2.0 ; 
        ...
        if (liftOverDrag <= 1000.) {
            con.outLD.setText(String.valueOf(filter3(liftOverDrag)));
        }
        if (liftOverDrag > 1000.) {
            con.outLD.setText(" - ");
        }
    ...
    public void loadProbe() {   // probe output routine
        ...
        pbval = 0.0;
        if (pboflag == 1) {
            pbval = vel * vfsd;           // velocity
        }
        if (pboflag == 2) {
            pbval = ((ps0 + pres * q0) / 2116.) * pconv; // pressure
        }
    ...
    class Con extends Panel {
        ...
        OriginalNasaApplet outerparent;
 ...
 //          in.anl.bt1.setBackground(Color.yellow) ;
            ...
            if (label.equals("Geometry")) {
                ...
                if (foil <= 3) {
                    ...
                    out.perf.prnt.appendText("\n Chord = " + filter3(chord));
                    if (lunits == 0) {
                        out.perf.prnt.appendText(" ft ,");
                    }
                    if (lunits == 1) {
                        out.perf.prnt.appendText(" m ,");
                    }
                ...
                if (lunits == 0) {
                    out.perf.prnt.appendText(" mph ,");
                }
                if (lunits == 1) {
                    out.perf.prnt.appendText(" km/hr ,");
                }
                ...
                volume = volume * span;
                if (foil >= 4) {
                    volume = 3.14159 * radius * radius * span;
                }
                if (foil >= 5) {
                    volume = 3.14159 * radius * radius * radius * 4.0 / 3.0;
                }

                out.perf.prnt.appendText("\n  Volume =" + filter3(volume));
                if (lunits == 0) {
                    out.perf.prnt.appendText(" cu ft ");
                }
                if (lunits == 1) {
                    out.perf.prnt.appendText(" cu m ");
                }
            }
            ...
            if (label.equals("Data")) {
                ...
                if (foil <= 3) {
                    ...
                    if (lunits == 0) {
                        out.perf.prnt.appendText(" sq ft ,");
                    }
                    if (lunits == 1) {
                        out.perf.prnt.appendText(" sq m ,");
                    }
                    out.perf.prnt.appendText("\n  Angle of attack = " + filter3(alfval));
                    out.perf.prnt.appendText(" degrees ,");
                }
                ...
                if (lftout == 0) {
                    ...
                    if (lunits == 0) {
                        out.perf.prnt.appendText(" lbs ");
                    }
                    if (lunits == 1) {
                        out.perf.prnt.appendText(" Newtons ");
                    }
                }
                if (dragOut == 1) {
        ...
        class Flt extends Panel {
            ...
            class Inr extends Panel {
                ...
                class Inr6 extends Panel {
                    ...
                    Inr6(OriginalNasaApplet target) {
                        outerparent = target;
                ...
                class Inr3 extends Panel {
                    ...
                    Inr3(OriginalNasaApplet target) {
                        outerparent = target;
                        setLayout(new GridLayout(1, 2, 2, 10));
                ...
                class Inr2 extends Panel {
                    ...
                    Inr2(OriginalNasaApplet target) {
                        outerparent = target;
                        setLayout(new GridLayout(1, 2, 2, 10));
                    ...
                    public boolean handleEvent(Event evt) {
                        ...
                        if (evt.id == Event.ACTION_EVENT) {
                            ...
                            if (planet == 3) {    // read in the temperature
                                ...
                                ts0 = v1 + 460.;
                                if (lunits == 1) {
                                    ts0 = (v1 + 273.1) * 9.0 / 5.0;
                                }
                                if (ts0 < 350.) {
                                    ts0 = 350.;
                                    v1 = ts0 - 460.;
                                    if (lunits == 1) {
                                        v1 = ts0 * 5.0 / 9.0 - 273.1;
                                    }
                                    fl1 = (float) v1;
        ...
        class Shp extends Panel {
            ...
            class Inr extends Panel {
                ...
                class Inr1 extends Panel {
                    ...
                    Inr1(OriginalNasaApplet target) {
            ...
            class Inl extends Panel {
                ...
                public boolean handleEvent(Event evt) {
                    ...
                    if (evt.id == Event.ACTION_EVENT) {
                        ...
                        if (span >= (spnold + .1) || span <= (spnold - .1)) {
                            choice = 2;
                        }
                        if (area >= (arold + 1.0) || area <= (arold - 1.0)) {
                            choice = 3;
                        }
                        switch (choice) {
...
//                   }
            ...
            class Inr extends Panel {
                ...
                class Sld1 extends Panel {  // chord slider
                    ...
                    Sld1(OriginalNasaApplet target) {
                        int i1;
                ...
                class Sld2 extends Panel {  // span slider
                    ...
                    Sld2(OriginalNasaApplet target) {
                        int i2;
                ...
                class Sld3 extends Panel {  // area slider
                    ...
                    Sld3(OriginalNasaApplet target) {
                        int i3;
...
// **** Impose pstatic on surface plot for stalled foil
                        if (anflag == 1 && index > 7) {
                            if (alfval > 10.0) {
                                plty[0][index] = plty[2][index];
                            }
                            if (alfval < -10.0) {
                                plty[1][index] = plty[2][index];
                            }
                        }
// *******
                    }
...
// *******
        ...
        //      begy = 0.0 ;
                    ...
                    if (lunits == 0) {
                        labyu = String.valueOf("mph");
                    }
                    if (lunits == 1) {
                        labyu = String.valueOf("kmh");
                    }
                    labx = String.valueOf(" X ");
                    if (foil <= 3) {
                        labxu = String.valueOf("% chord");
...
//
                ...
                if (dispp == 5) {    // lift and drag versus speed
                    ...
                    for (ic = 1; ic <= npt; ++ic) {
                        ...
                        if (doutb == 1) {
                            plty[0][ic] = fconv * drgref * spd * spd / (vfsd * vfsd);
                        }
                    }
                    ntiky = 5;
                    if (doutb == 0) {
                ...
                if (dispp == 6) {    // lift and drag versus altitude
                    ...
                    if (lunits == 0) {
                        labxu = String.valueOf("k-ft");
                    }
                    if (lunits == 1) {
                        labxu = String.valueOf("km");
                    }
                    del = altmax / npt;
                    for (ic = 1; ic <= npt; ++ic) {
                        hpl = (ic - 1) * del;
                        ...
                        if (planet == 0) {
                            ...
                            if (doutb == 1) {
                                plty[0][ic] = fconv * drgref * ppl / (tpl * 53.3 * 32.17) / rho;
                            }
                        }
                        if (planet == 1) {
                            if (hpl <= 22960.) {
                            ...
                            if (doutb == 1) {
                                plty[0][ic] = fconv * drgref * ppl / (tpl * 1149.) / rho;
                            }
                        }
                        if (planet == 2) {
                            if (doutb == 0) {
                ...
                if (dispp == 7) {    // lift and drag versus area
                    ...
                    if (lunits == 1) {
                        ...
                        if (doutb == 1) {
                            plty[0][2] = fconv * drgref * 200. / area;
                        }
                    }
                ...
                if (dispp == 8) {    // lift and drag versus density
                    ...
                    if (planet == 0) {
                        if (lunits == 0) {
                            ...
                            if (doutb == 1) {
                                plty[0][2] = fconv * drgref * 23.7 / (rho * 10000.);
                            }
                            pltx[1][0] = rho * 10000.;
                        }
                        if (lunits == 1) {
                    ...
                    if (planet == 1) {
                        if (lunits == 0) {
                            ...
                            if (doutb == 1) {
                                plty[0][2] = fconv * drgref * 2.93 / (rho * 100000.);
                            }
                            pltx[1][0] = rho * 100000.;
                        }
                        if (lunits == 1) {
...
//
                ...
                if (dispp >= 0 && dispp <= 1) {    // determine y - range
                    if (calcrange == 0) {
                        ...
                        endy = plty[0][1];
                        for (index = 1; index <= npt2; ++index) {
                            if (plty[0][index] < begy) {
                                begy = plty[0][index];
                            }
                            if (plty[1][index] < begy) {
                                begy = plty[1][index];
                            }
                            if (plty[0][index] > endy) {
                                endy = plty[0][index];
                            }
                            if (plty[1][index] > endy) {
                                endy = plty[1][index];
                            }
                        }
                        calcrange = 1;
            ...
            public void paint(Graphics g) {
                ...
                if (dispp == 20) {      /*  draw the lift and drag gauge */
                    ...
                    if (lftout == 0) {
                        ...
                        if (lunits == 0) {
                            off2Gg.drawString("Pounds", 190, 75);
                        }
                        if (lunits == 1) {
                            off2Gg.drawString("Newtons", 190, 75);
                        }
                    }
                    if (lftout == 1) {
                    ...
                    if (dragOut == 0) {
                        ...
                        if (lunits == 0) {
                            off2Gg.drawString("Pounds", 190, 185);
                        }
                        if (lunits == 1) {
                            off2Gg.drawString("Newtons", 190, 185);
                        }
                    }
                    if (dragOut == 1) {
                        off2Gg.drawString(" Cd  =", 70, 185);
                    }
            ...
            class R extends Panel {
                ...
                class L2 extends Canvas {
                    ...
                    public void paint(Graphics g) {
                        ...
                        if (pboflag == 0 || pboflag == 3) {
                            off3Gg.setColor(Color.gray);
                        }
                        if (pboflag == 1 || pboflag == 2) {
                        ...
                        if (pboflag == 1) {
                            ...
                            if (lunits == 0) {
                                off3Gg.drawString("mph", 50, 125);
                            }
                            if (lunits == 1) {
                                off3Gg.drawString("km/h", 50, 125);
                            }
                        }
                        if (pboflag == 2) {
                            off3Gg.drawString("Pressure", 30, 15);
                            if (lunits == 0) {
                                off3Gg.drawString("psi", 50, 125);
                            }
                            if (lunits == 1) {
                                off3Gg.drawString("kPa", 50, 125);
                            }
                        }
        ...
        class Perf extends Panel {
            ...
            Perf(OriginalNasaApplet target) {
    ...
    class Viewer extends Canvas
        ...
        Viewer(OriginalNasaApplet target) {
            setBackground(Color.black);
            runner = null;
        }
